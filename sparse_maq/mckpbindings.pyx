...
from sparse_maq.mckpdefs cimport (
    vector, string, solution_path, solver_output, run, run_flat,
...
cpdef solver_cpp_old(
    ...
    cdef solver_output result = run(cpp_treatment_ids, cpp_rewards, cpp_costs, budget)
